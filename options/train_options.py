...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument("--display_port", type=int, default=1234, help="visdom port of the web display")
        parser.add_argument(
        ...
        parser.add_argument(
            "--save_epoch_freq", type=int, default=2, help="frequency of saving checkpoints at the end of epochs"
        )
        ...
        parser.add_argument("--type", type=str, default="train", help="train, val, test, etc")
        # training parameters
        parser.add_argument(
            "--n_epochs", type=int, default=100, help="number of epochs with the initial learning rate"
        )
        parser.add_argument(
            "--n_epochs_decay", type=int, default=200, help="number of epochs to linearly decay learning rate to zero"
        )
        ...
        parser.add_argument(
            ...
            type=str,
            default="hinge",
            help="the type of GAN objective. [vanilla| lsgan | wgangp| hinge]. vanilla GAN loss is the cross-entropy objective used in the original GAN paper.",
        )
        parser.add_argument(
            "--pool_size",
            type=int,
        ...
        parser.add_argument("--mask_ratio", type=float, default=0.2, help="the mask ratio of RealB")
